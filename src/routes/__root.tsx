    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          जिस पेज को आप खोज रहे हैं वह उपलब्ध नहीं है या किसी दूसरे स्थान पर ले जाया गया है।
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-foreground">यह पेज लोड नहीं हो सका</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          हमारी ओर से कुछ गड़बड़ी हुई है। आप फिर से प्रयास कर सकते हैं या होम पेज पर लौट सकते हैं।
        </p>
